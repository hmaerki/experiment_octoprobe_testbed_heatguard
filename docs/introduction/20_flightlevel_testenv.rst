...
Tests always run against a specific `testbed`. See: :doc:`/implementation/index`.

This secion is about specifying such a testbed_heatguard.
...
File: src/testbed_heatguard/constants.py
...
File: src/testbed_heatguard/tentacles_spec.py
...
File: src/testbed_heatguard/tentacle_specs.py
...
* A *testbed* is the specification of how the tentacles are populated and wired and how to test the different FUT.
  ...
  * Testbed/Tentacle specification
    ...
    * src/testbed_heatguard/tentacle_spec_mcuconfig.py
    * src/testbed_heatguard/tentacles_spec.py
...
.. literalinclude:: ../../src/testbed_heatguard/tentacles_inventory.py
   :language: python
   :linenos:
