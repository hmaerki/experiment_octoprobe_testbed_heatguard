...
Every testbed requires a unique name. This here is called `testbed_heatguard`.
...
`testbed_heatguard` is designed to demonstrates the various aspects of octoprobe. But also allows to write/run meaningful tests.
