...
git clone testbed_heatguard
--------------------------

.. code::

    git clone https://github.com/octoprobe/testbed_heatguard.git
...
.. code::
    ...
    echo 'source ~/testbed_heatguard/.venv/bin/activate' >> ~/.profile
