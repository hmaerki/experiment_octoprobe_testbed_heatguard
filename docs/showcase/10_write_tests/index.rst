...
Why should I start with ``testbed_heatguard``
-----------------------------------------------------

``testbed_heatguard`` should run out of the box and it includes all layers of Octoprobe and pytest.

With ``testbed_heatguard`` running, you have a reference to derive your tests or extensions.
